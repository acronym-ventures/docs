...
These rules apply to people who use a website called [beta.acronym.fi](https://beta.acronym.fi/). It's essential to read these rules carefully to understand what they say. If you create an account, put money into it, or use any of the services offered on the Vault, you agree to follow these rules.
...
2.2. To create an Account, you must provide your email address, password, and country of residence. Additionally, you are required to set up a Master Password and enable two-factor authentication ("2FA") during the signup process and agree to these terms.
